  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500">{templates.length} template · klik Edit untuk menyesuaikan subject dan isi email.</p>
      </div>
        ...
        <table className="w-full text-sm">
          <thead className="border-b border-gray-100 bg-gray-50">
            <tr>
              ...
              <th className="px-4 py-3 text-left font-semibold text-gray-600">Diubah</th>
              <th className="w-16" />
            </tr>
          </thead>
