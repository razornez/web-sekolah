    ...
    $('body').append('' +
        '<div id="styleSelector" class="menu-styler">' +
            ...
            '<div class="style-block">' +
                '<h4 class="mb-2">Smart School <small class="font-weight-normal">v3.1 Customizer</small></h4>' +
                '<hr class="">' +
                '<div class="m-style-scroller">' +
                    ...
                    '<div class="theme-color background-color gradient">' +
                        ...
                        '<a href="#!" class="active" data-value="background-grd-info"><span></span><span></span></a>' +
