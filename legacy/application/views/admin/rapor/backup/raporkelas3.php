                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#!">Data Rapor Semester 3</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="table-responsive">
                        <table id="report-table" class="table table-bordered table-striped mb-0">
                            ...
                            <tbody><?php $no = 1; foreach($datakelas as $res){ ?>
                                    ...
                                    <a href="<?php echo base_url() ?>master/nilairapor3/<?php echo $res->nama_kelas ?>" class="btn btn-icon btn-info btn-sm"><i class="feather icon-search"></i></a>  
                                    </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
