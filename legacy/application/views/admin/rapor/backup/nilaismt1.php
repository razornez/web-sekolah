    ...
    <div class="pcoded-content">
        ...
        <div class="row">
            <div class="col-xl-2 col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <div class="form-group mb-0"><?php foreach($nilai_smt1 as $res){ ?>  <?php } ?>
                            <a href="<?php echo base_url() ?>master/hapussemuanilaismt1/<?php echo $res->kode_mapel ?>" class="btn btn-danger btn-sm btn-round has-ripple" ><i class="fa fa-download"></i> Kosongkan</a>
                        </div>
                        <br>
                        <div class="form-group mb-0">
                            <a href="#" class="btn btn-info btn-sm btn-round has-ripple" data-toggle="modal" data-target="#modal-import"><i class="fa fa-upload"></i> Impor Nilai</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="table-responsive">
                        <table id="report-table" class="table table-bordered table-striped mb-0">
                            ...
                            <tbody><?php $no = 1; foreach($nilai_smt1 as $res){ ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-inline-block align-middle">
                                            ...
                                            <div class="d-inline-block">
                                                ...
                                                <p class="m-b-0"><strong><?php echo $res->nama_kelas ?> / <?php echo $res->nomor_absen ?></strong> - <?php echo $res->mapel ?></p>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <a href="<?php echo base_url() ?>master/hapusnilaismt1/<?php echo $res->id_rapor ?>" class="btn btn-icon btn-danger btn-sm tombol-hapus"><i class="feather icon-trash-2"></i></a>
                                    </td>
                                </tr>
