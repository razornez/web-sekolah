                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Surat Undangan Wali Murid </h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="#!">Sekolah</a></li>
                            <li class="breadcrumb-item"><a href="#!">Surat Undangan </a></li>
                        </ul>
                    </div>
                </div>        
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="report-table" class="table table-bordered table-striped mb-0">
                                ...
                                <tbody><?php $no = 1; foreach($dataundanganwalimurid as $res){ ?>
                                    <tr>
                                        ...
                                        <div class="d-inline-block align-middle">
												...
												<div class="d-inline-block">
													<h6 class="m-b-0">Tingkat - <?php echo $res->nama_tingkat ?></h6>
													<p class="m-b-0"></p> 
												</div>
											</div>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <a href="<?php echo base_url() ?>master/print_undanganwalimurid/<?php echo $res->tingkat ?>" class="btn btn-icon btn-info btn-sm"><i class="feather icon-printer"></i></a>
                                            <a href="<?php echo base_url() ?>master/hapusundanganwalimurid/<?php echo $res->id_undanganwalimurid ?>" class="btn btn-icon btn-danger btn-sm tombol-hapus"><i class="feather icon-trash-2"></i></a>
                                        </td>
                                    </tr>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url() ?>master/simpanundanganwalimurid" method="post" enctype="multipart/form-data" role="form">
                    <div class="row">
                        ...
                        <div class="col-sm-8 text-black mb-3">
                            <div class="table-responsive">
                            <table id="report-table-undanganortu" class="table table-bordered table-striped mb-0" style="width:100%">
                                <thead>
                                ...
                                <tbody><?php $no = 1; foreach($datatingkat as $key){ ?>
                                    <tr class="text-black">
                                        <td class="text-center"><input type="checkbox" id="tingkat" name="tingkat" value="<?php echo $key->nama_tingkat?>"></td>
                                        <td><?php echo $key->nama_tingkat ?> </td>
                                    </tr><?php } ?>
                                </tbody>
                            </table>
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="Jam" id="Jam" class="form-control" placeholder="07:00 - 09:00">
                            </div>

                            <div class="form-group">
                                <label class="floating-label" for="kegiatan">Acara / Kegiatan</label>
                                <input type="text" name="kegiatan" id="kegiatan" class="form-control" placeholder="Rapat Wali Murid">
                            </div>
