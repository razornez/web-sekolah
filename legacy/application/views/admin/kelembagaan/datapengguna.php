                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="email" name="email" value="<?php echo $res->email ?>" placeholder="info@exampremium.co.id">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="notelp" name="notelp" value="<?php echo $res->notelp ?>" placeholder="081222913903">
                                                                </div>
                                                            </div>
