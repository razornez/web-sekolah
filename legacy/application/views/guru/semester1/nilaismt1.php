                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group mb-0"><?php foreach($nilai_smt1 as $res){ ?>  <?php } ?>
                            <a href="<?php echo base_url() ?>master/hapussemuanilaismt1/<?php echo $res->kode_mapel ?>" class="btn btn-danger btn-sm btn-round has-ripple" ><i class="fa fa-download"></i>Kosongkan Nilai</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <tbody><?php $no = 1; foreach($nilai_smt1 as $res){ ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="<?php echo base_url() ?>guru/dashboard/cetak_rapor1/<?php echo $res->id_pendaftar ?>" class="btn btn-icon btn-primary btn-sm"><i class="feather icon-printer"></i></a>
                                    </td>
                                </tr>
