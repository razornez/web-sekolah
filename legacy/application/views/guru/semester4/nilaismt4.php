    ...
    <div class="pcoded-content">
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#!">Semester 4</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-xl-2 col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <div class="form-group mb-0"><?php foreach($nilai_smt4 as $res){ ?>  <?php } ?>
                            <a href="<?php echo base_url() ?>master/hapussemuanilaismt4/<?php echo $res->kode_mapel ?>" class="btn btn-danger btn-sm btn-round has-ripple" ><i class="fa fa-download"></i>Kosongkan Nilai</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="table-responsive">
                        <table id="report-table" class="table table-bordered table-striped mb-0">
                            ...
                            <tbody><?php $no = 1; foreach($nilai_smt4 as $res){ ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="<?php echo base_url() ?>guru/dashboard/cetak_rapor4/<?php echo $res->id_pendaftar ?>" class="btn btn-icon btn-primary btn-sm"><i class="feather icon-printer"></i></a>
                                    </td>
                                </tr>
