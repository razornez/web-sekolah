                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#!">Dashboard Resepsionis</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-12">
                    <div class="card task-board-left">
                        <div class="card-header card-border-c-blue text-center">
                        <?php echo $data_lembaga->nama_lembaga; ?>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-xl-9 col-lg-12">
                    <div class="card card-border-c-blue">
                        <div class="card-header">
                                <h4>INFORMASI DATA LEMBAGA</h4><hr>
