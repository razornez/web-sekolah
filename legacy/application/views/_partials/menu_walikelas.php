		...
		<div class="navbar-wrapper  ">
			<div class="navbar-content scroll-div " >
				...
				<div class="">
					<div class="main-menu-header">
						...
						<div class="user-details">
							<div id="more-details"><?php foreach($data_walikelas as $walikelas){ ?> <?php echo $walikelas->nama_guru ?>   <?php } ?><i class="fa fa-caret-down"></i></div>
						</div>
					</div>
				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item">
						<a href="<?php echo base_url() ?>walikelas/dashboard" class="nav-link ">
          			...
          			<li class="nav-item"><a href="<?php echo base_url() ?>walikelas/dashboard/logout" class="nav-link ">
				...
				<div class="card text-center">
					<div class="card-block">
						...
						<a href="#!" target="_blank" class="btn btn-primary btn-sm text-white m-0">Support by Exampremium</a>
					</div>
				</div>
  	...
  	<header class="navbar pcoded-header navbar-expand-lg navbar-light header-blue">
				...
				<div class="m-header">
					...
					<a href="#!" class="b-brand">
						...
						<img style="width:150px;100px;" src="<?php echo base_url() ?>resources/images/logo.png" alt="" class="logo">
