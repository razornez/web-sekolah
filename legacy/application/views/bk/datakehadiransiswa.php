                    ...
                    <div class="card-header">
                        ...
                        ?>
                            ...
                            <div class="col-sm-12 text-right">
                                <a href="<?php echo base_url() ?>bk/dashboard/exportpresensisiswa" class="btn btn-primary btn-sm btn-round has-ripple" ><i class="fas fa-file-pdf"></i> Laporan</a>
                            </div>
                                        ...
                                        <td class="text-center">
                                            <strong>
                                                <?php 
                                                    ...
                                                    $datang = strtotime($res->waktu_presensi);
                                                    $diff  = $datang - $absen;
