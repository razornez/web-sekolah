                    ...
                    <div class="card-body">
                        <div class="row align-items-center m-l-0">
                            ...
                            <div class="col-sm-6 text-right">
                                <button class="btn btn-info btn-sm btn-round has-ripple" data-toggle="modal" data-target="#modal-tambahkategoripelanggaran"><i class="fas fa-plus-circle"></i> Tambah</button>
                            </div>
                        </div>
                                ...
                                <tbody><?php $no = 1; foreach($datakategoripelanggaran as $res){ ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?php echo base_url() ?>bk/dashboard/hapuskategoripelanggaran/<?php echo $res->id_kategorikasus ?>"  class="btn btn-icon btn-danger btn-sm tombol-hapus" ><i class="feather icon-trash-2"></i></a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url() ?>bk/dashboard/simpankategoripelanggaran" method="post" enctype="multipart/form-data" role="form">
                    <div class="row">
