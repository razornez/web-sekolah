        ...
        <div class="container">
          <div class="row">
            <div class="card card-span">
              <div class="card-body">
                <div class="row flex-center gx-0 bg-primary">
                  ...
                  <div class="col-lg-8 col-xl-4">
                    <h1 class="text-dark fs-lg-4 fs-xl-5">Video Pembelajaran</h1>
                  </div>
                  </div>
                ...
                <div class="container">
                    <div class="row">
                      ...
                      <div class="shadow-sm col-md-3 mb-3">
                        <div class="card h-100 img-thumbnail">
                          <iframe class="card-img-top w-100" src="https://www.youtube.com/embed/<?php echo $res->file_video ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" alt="courses" allowfullscreen></iframe>
                          <div class="card-body">
                            <h5 class="font-sans-serif fw-bold fs-md-0 fs-lg-1 text-center"><?php echo $res->nama_video ?></h5><a class="text-muted fs--1 stretched-link text-decoration-none" href="<?php echo $res->file_video ?>" data-toggle="modal" data-target="#modal-report2<?php echo $res->id_video ?>"></a>
                            
                          </div>
                          Untuk Kelas : <?php echo $res->kelas_video ?> | <?php echo $res->kategori ?>
