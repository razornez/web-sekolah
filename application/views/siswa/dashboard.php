...
<div class="pcoded-main-container">
    <div class="pcoded-content">
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo base_url() ?>pengguna/dashboard">Dashboard Siswa</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <?php  foreach($data_pendaftar as $datacount){ ?><?php } ?>
        <!-- [ Main Content ] start -->
        <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="card support-bar overflow-hidden">
                            <div class="card-body pb-0">
                                ...
                                <h2 class="m-0"><?php echo $this->db->where(['nisn'=>"$datacount->nisn"])->from("spp_datasiswa")->count_all_results();?></h2>
                                <span class="text-c-blue">Data Pembayaran</span>
                                <p class="mb-3 mt-3">Data Diambil Dari Database</p>
                            </div>
                    ...
                    <div class="col-sm-6">
                        <div class="card support-bar overflow-hidden">
                            <div class="card-body pb-0">
                                <h2 class="m-0">-</h2>
                                <span class="text-c-green">Data</span>
                                <p class="mb-3 mt-3">Data Diambil Dari Database</p>
                            </div>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            ...
                            <div class="card-footer bg-c-yellow">
                                <div class="row align-items-center">
                                    <div class="col-9">
                                        <p class="text-white m-b-0">Pembaharuan</p>
                                    </div>
                    ...
                    <div class="card-body">
                        <div class="client-detail">
                            ...
                            <div class="client-contain">
                                ...
                                <a href="#!" class="text-muted"><h6><?php echo $data_lengkap->nama_kelas ?> Absen : (<?php echo $data_lengkap->siswa_nomorabsen ?>)</h6></a>
                            ...
                            <div class="client-card-box">
                                <div class="row">
                                    <div class="col-6 text-center client-border p-10">
                                        <p class="text-muted m-0 font-weight-bolder">ASAL SEKOLAH</p>
                                       <span class="text-c-blue f-11 f-w-600"><?php echo $data_lengkap->asal_sekolah ?></span>
                                    </div>
                                    <div class="col-6 text-center p-10">
                                        <p class="text-muted m-0 font-weight-bolder">NISN</p>
                                        <span class="text-c-red f-17 f-w-600"><?php echo $data_lengkap->nisn ?></span>
                                    </div>
                                </div>
                                <div class="col-sm-12 client-border-card p-t-10">
                                    ...
                                    <div class="table-responsive">
                                        <table id="report-table" class="table table-bordered table-striped mb-0">
                                            ...
                                            <tbody>
                                            <?php foreach($data_kasus as $data_kasussiswa){ ?>
                                                <tr>
                                                    <td><strong><?php echo $data_kasussiswa->nama_kasus ?></strong></td>
                                                    <td class="text-center"><strong style="color:blue;"><?php echo $data_kasussiswa->poin ?></strong></td> 
                                                </tr>
                                                <?php } ?>
                                            </tbody>
                                        </table>
            ...
            <div class="col-xl-6 col-md-12">
                ...
                <div class="card user-card2">
                    <div class="card-body text-center">
                        ...
                        <div class="risk-rate">
                            <h6><b style="color:black;"><?php echo $data_lengkap->nama_kelas ?></b></h6>
                        </div>
                        <h3 class="m-b-10 m-t-10"><?php echo $data_lengkap->nama_lengkap ?></h3>
                       
                        <div class="row justify-content-center m-t-10 b-t-default m-l-0 m-r-0">
                            <div class="col m-t-15 b-r-default">
                                <h6 class="text-muted">NIK</h6>
                                <h6><?php echo $data_lengkap->nik ?></h6>
                            </div>
                            <div class="col m-t-15">
                                <h6 class="text-muted">Tempat Dan Tanggal Lahir</h6>
                                <h6><?php echo $data_lengkap->tempatlahir ?>, <?php echo $data_lengkap->tanggallahir ?></h6>
                            </div>
                        </div>
                    </div><?php } ?>
                 
                    <a href="<?php echo base_url() ?>pengguna/dashboard/editsiswa/<?php echo $data_lengkap->id_pendaftar ?>" class="btn btn-info btn-sm btn-block">Lihat Data</a>
                </div>
            </div>
                    ...
                    <div class="carousel-inner text-center">
                        <div class="carousel-item active" data-interval="50000">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-9">
                                    <p class="f-16"><strong>SmartSchool v.<?php foreach($setting as $ver){ ?><?php echo $ver->version ?> <?php } ?></strong> Terus Dalam Penyempurnaan.</p>
