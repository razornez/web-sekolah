                    ...
                    <div class="card-body">
                        <div class="row align-items-center m-l-0">
                            ...
                            <div class="col-sm-6 text-right">
                                <button class="btn btn-info btn-sm btn-round has-ripple" data-toggle="modal" data-target="#modal-report2"><i class="feather icon-plus"></i> Absen Masuk</button>
                            </div>
                        </div>
                    ...
                    <div class="card-body p-1">
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                ...
                                <?php $no = 1; foreach($jadwalkehadiransiswa as $ress){ ?>
                                    <tr>
                                        <td><?php echo $ress->hari ?></td>
                                        <td><?php echo $ress->jam_masuk_awal ?> - <?php echo $ress->jam_masuk_akhir ?></td>
                                        <td><?php echo $ress->jam_pulang_awal ?> - <?php echo $ress->jam_pulang_akhir ?></td>
                    ...
                    <div class="card-body p-1">
                        <div class="table-responsive">
                            <table id="report-table" class="table table-bordered table-striped mb-0">
                                ...
                                <tbody><?php $no = 1; foreach($datakehadiransiswa as $res)
                                    { ?>
                                    <tr>
                                        <td class="text-center"><?php echo $no++ ?></td>
                                        <td class="text-center"><?php echo $res->id_hari ?></td>
                                        <td class="text-center"><?php echo $res->tanggalpresensi ?></td>
                                        <td class="text-center" style="color:green;"><Strong><?php echo $res->stempel_presensi ?></Strong></td>
                                        ...
                                        <td class="text-center" style="color:blue;"><strong><?php echo $res->out_presensi ?></strong></label></td>
                                        <td class="text-center"><a href="<?php echo base_url() ?>pengguna/dashboard/editkehadiransiswa/<?php echo $res->id_kehadiran ?>" data-toggle="modal" data-target="#modal-report2<?php echo $res->id_kehadiran ?>" class="btn btn-dark btn-sm"><i class="feather icon-plus"></i>Pulang</a></td>
                                    </tr>
                                </tbody>
                                        ...
                                        <div class="modal-dialog modal-md">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="<?php echo base_url() ?>pengguna/dashboard/updatekehadiransiswa" method="POST">
                                                        <div class="row">
...
<?php foreach($data_pendaftar as $res) { ?> <?php } ?>
...
<div class="modal fade" id="modal-report2" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url() ?>pengguna/dashboard/simpankehadiransiswa" method="post" enctype="multipart/form-data" role="form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nama_siswa" name="nama_siswa" value="<?php echo $this->session->userdata("user_nama") ?>" readonly>
                                <input type="hidden" class="form-control" id="status_presensi" name="status_presensi" value="Hadir">
                                <input type="hidden" class="form-control" id="kelas" name="kelas" value="<?php echo $this->session->userdata("user_kelas") ?>">
                                <input type="hidden" class="form-control" id="nomorabsen" name="nomorabsen" value="<?php echo $this->session->userdata("user_nomorabsen") ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label for="stempel_presensi">Jam</label>
                                <input type="text" class="form-control" id="stempel_presensi" name="stempel_presensi" value="<?php echo  date("H:i:s"); ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="id_hari" name="id_hari" value="<?php
                                    $tanggal = '2017-01-31';
                        ...
                        <div class="col-sm-12">
                            <button class="btn btn-primary" id="pnotify-success">Absen Sekarang</button>
                        </div>
                    </div>
                </form>
            </div>
