    ...
    <div class="w-full flex flex-wrap">
        ...
        <div class="w-full md:w-1/2 flex flex-col">
            ...
            <div class="flex flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
                <p class="text-left text-5xl" style="color:#087990"><u><strong>Login</strong></u><span class="text-left text-2xl" style="color:#3F6F81"><strong>E-KINERJA</strong></span><p>
                  <h5 style="color:#087990"><strong style="color:#087990">Selamat Datang Di Halaman Login</strong> <br>Sistem Login SmartSchool </h5>


                 

                <form action=" <?php echo base_url() ?>loginguru" method="POST" class="flex flex-col pt-3 md:pt-4">
        ...
        <div class="w-1/2 shadow-2xl">
            <img class="object-cover w-full h-screen hidden md:block" src="resources/images/loginpage/bg-loginekinerja.jpg">
        </div>
    </div>
