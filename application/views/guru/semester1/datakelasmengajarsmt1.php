        ...
        <div class="pcoded-content">
                                    ...
                                    <tbody><?php $no = 1; foreach($datakelasmengajar as $res){ ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="<?php echo base_url() ?>guru/dashboard/nilaismt1/<?php echo $res->kode_mapel ?>/<?php echo $res->kode_kelas ?>" class="btn btn-icon btn-info btn-sm"><i class="feather icon-search"></i></a>
                                                <a href="<?php echo base_url() ?>guru/dashboard/hapusraporkelas/<?php echo $res->id_dataguru ?>/<?php echo $res->tahun ?>" class="btn btn-icon btn-danger btn-sm tombol-hapus"><i class="feather icon-trash-2"></i></a>
                                            </td>
                                        </tr>
                                    </tbody>
            ...
            <div class="modal fade" id="modal-tambahkelasmengajar" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-md">
                    ...
                    <div class="modal-body">
                        <form action="<?php echo base_url() ?>guru/dashboard/simpankelasmengajarsmt1" method="post" enctype="multipart/form-data" role="form">
                            <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="semester_guru" name="semester_guru">
                                        <option value="raporsemester1">Semester 1</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label class="floating-label" for="nama_tahun">Tahun</label>
                                        <input type="number" class="form-control" id="nama_tahun" name="nama_tahun" required>
                                </div>
                            </div>
