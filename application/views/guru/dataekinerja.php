        ...
        <div class="pcoded-content">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">Data Ekinerja</h5>
                            </div>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.html"><i class="feather icon-home"></i></a></li>
                                <li class="breadcrumb-item"><a href="#!">Guru</a></li>
                                <li class="breadcrumb-item"><a href="#!">Data E-kinerja</a></li>
                            </ul>
                        </div>
                    </div>        
                </div>
                        ...
                        <div class="card-body">
                            <div class="row align-items-center m-l-0">
                                <div class="col-sm-12 text-right">
                                    <button class="btn btn-info btn-sm btn-round has-ripple" data-toggle="modal" data-target="#modal-tambahbuku"><i class="feather icon-plus"></i> Tambah SKP</button>
                                </div>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table id="report-table" class="table table-bordered table-striped mb-0">
                                    ...
                                    <tbody><?php $no = 1; foreach($data_ekinerja as $res){ ?>
                                        <tr>
                                            <td class="text-center"><?php echo $no++ ?></td>
                                            <td class="text-center"><Strong style="color:green;"><?php echo tgl_indo(date($res->dari)) ?></strong> - <strong style="color:red;"><?php echo tgl_indo(date($res->sampai)) ?></strong></td>   
            ...
            <div class="modal fade" id="modal-tambahbuku" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Tambah Data E-kinerja</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form action="<?php echo base_url() ?>guru/dashboard/simpandataekinerja" method="post" enctype="multipart/form-data" enctype="multipart/form-data" role="form">
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="dari" name="dari" value="<?php echo date("d-m-Y"); ?>" autocomplete="off" required="" oninvalid="this.setCustomValidity('Tanggal Mulai Target SKP Harus Diisi')" oninput="setCustomValidity('')">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="sampai" name="sampai" value="<?php echo date("d-m-Y"); ?>" autocomplete="off" required="" oninvalid="this.setCustomValidity('Tanggal Akhir Target SKP Harus Diisi')" oninput="setCustomValidity('')">
                                    </div>
                                </div>
