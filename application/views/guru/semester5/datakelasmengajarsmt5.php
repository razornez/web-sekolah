            ...
            <div class="modal fade" id="modal-tambahkelasmengajar" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-md">
                    ...
                    <div class="modal-body">
                        <form action="<?php echo base_url() ?>guru/dashboard/simpankelasmengajarsmt5" method="post" enctype="multipart/form-data" role="form">
                            <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="semester_guru" name="semester_guru">
                                        <option value="raporsemester5">Semester 5</option>
                                    </select>
                                </div>
                            </div>
