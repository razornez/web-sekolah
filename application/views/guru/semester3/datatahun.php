                            ...
                            <table id="report-table" class="table mb-0">
                                ...
                                <tbody><?php $no = 1; foreach($datatahun as $res){ ?>
                                    <tr class="text-center">
                                        ...
                                        <td class="text-center"><a href="<?php echo base_url() ?>guru/dashboard/datakelasmengajarsmt3/<?php echo $res->tahun ?>" class="btn btn-icon btn-info btn-sm"><i class="feather icon-search"></i></a></td>
