                                ...
                                <table id="report-table" class="table table-bordered table-striped mb-0">
                                    ...
                                    <tbody><?php $no = 1; foreach($datakelasmengajar as $res){ ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><a href="<?php echo base_url() ?>guru/dashboard/nilaismt4/<?php echo $res->kode_mapel ?>/<?php echo $res->kode_kelas ?>" class="btn btn-icon btn-info btn-sm"><i class="feather icon-search"></i></a></td>
                                        </tr>
                                    </tbody>
                                    <?php } ?>
                                </table>
            ...
            <div class="modal fade" id="modal-tambahkelasmengajar" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-md">
                    ...
                    <div class="modal-body">
                        <form action="<?php echo base_url() ?>guru/dashboard/simpankelasmengajarsmt4" method="post" enctype="multipart/form-data" role="form">
                            <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="semester_guru" name="semester_guru">
                                        <option value="raporsemester4">Semester 4</option>
                                    </select>
                                </div>
                            </div>
...
<div class="modal fade" id="modal-import" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="<?php echo base_url() ?>guru/dashboard/uploadnilaismt4" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-12">
