    ...
    <div class="w-full flex flex-wrap">
        ...
        <div class="w-full md:w-1/2 flex flex-col">
            ...
            <div class="flex flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
                <p class="text-left text-5xl" style="color:#087990"><u><strong>Login</strong></u><span class="text-left text-2xl" style="color:#3F6F81"><strong>BAGIAN SARPRAS</strong></span><p>
                ...
                <form action=" <?php echo base_url() ?>loginsarpras" method="POST" class="flex flex-col pt-3 md:pt-4">
