...
<head>
    ...
    <!-- Tailwind -->
        ...
        <link href="<?php echo base_url() ?>assets/css/loginadmin.css" rel="stylesheet">
    </head>
        ...
        <div class="w-full flex flex-wrap">
            ...
            <div class="w-full md:w-1/2 flex flex-col">
                <div class="flex flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
                    <p class="text-left text-5xl" style="color:#087990"><u><strong>Login</strong></u><span class="text-left text-2xl" style="color:#3F6F81"><strong>ADMINISTRATOR</strong></span><p>
                    ...
                    <form action="<?php echo base_url() ?>login" method="POST" class="flex flex-col pt-3 md:pt-4">
                    ...
                    <div class="text-center pt-12 pb-12">
                        <p>Perlu Bantuan ? <a href="#" class="underline font-semibold">Hubungi Bagian IT</a></p>
                    </div>
                </div>
            </div>
            <!-- Image Section -->
            <div class="w-1/2 shadow-2xl">
                <img class="object-cover w-full h-screen hidden md:block" src="resources/images/admin/login-admin.gif">
            </div>
        </div>
    </body>
