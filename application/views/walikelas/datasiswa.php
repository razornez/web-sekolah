                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="report-table" class="table table-bordered table-striped mb-0">
                                ...
                                <tbody><?php $no = 1; foreach($data_rombel as $res){ ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?php echo base_url() ?>walikelas/dashboard/editsiswa/<?php echo $res->id_pendaftar ?>" class="btn btn-icon btn-info btn-sm"><i class="feather icon-edit"></i></a> 
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
