                            ...
                            <div class="card social-card bg-c-red">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <h6 class="m-b-0 text-white">Peserta Didik</h6>
                                            <p><?php echo $this->db->count_all_results('pendaftar'); ?> siswa</p>
                        ...
                        <div class="card social-card bg-c-blue">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <h6 class="m-b-0 text-white">Guru Dan Pegawai</h6>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="text-center">
                        <h3 class="mt-3">Selamat Datang Di <span class="text-primary">SmartSchool</span><sup>v3.1</sup></h3>
                    </div>
                    <div class="carousel-inner text-center">
                        <div class="carousel-item active" data-interval="50000">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-9">
                                    <p class="f-16"><strong>SmartSchool v3.1</strong> Terus Dalam Penyempurnaan.</p>
