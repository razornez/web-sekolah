                            ...
                            <table id="report-table" class="table table-bordered table-striped mb-0">
                                ...
                                <tbody><?php $no = 1; foreach($datamutasisiswa as $res){ ?>
                                    <tr>
                                        ...
                                        <td class="text-center"><?php echo $res->sekolah ?></td>
                                        <td class="text-center"><?php echo $res->nosurat ?></td>
                                        <td class="text-center"><?php echo $res->status ?></td>
                                
                                        <td class="text-center">
                                            <a href="<?php echo base_url() ?>bk/dashboard/cetak_mutasi/<?php echo $res->id_siswa ?>" class="btn btn-icon btn-info btn-sm"><i class="feather icon-printer"></i></a>
                                            <a href="<?php echo base_url() ?>bk/dashboard/hapusmutasikeluar/<?php echo $res->id_mutasisiswa ?>" class="btn btn-icon btn-danger btn-sm tombol-hapus"><i class="feather icon-trash-2"></i></a>
                                        </td>
                                    </tr>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Mutasi Keluar</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="<?php echo base_url() ?>bk/dashboard/simpanmutasikeluar" method="post" enctype="multipart/form-data" role="form">
                    <div class="row">




                        <div class="col-sm-8 text-white bg-info  mb-3">
                            <div class="table-responsive">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <label class="floating-label" for="tanggal">Tanggal Pindah</label>
                                <input type="date" name="tanggal" id="tanggal" class="form-control" placeholder="tanggal">
                            </div>

                            <div class="form-group">
                                <label class="floating-label" for="alasan">Sekolah Tujuan</label>
                                <input type="text" name="sekolah" id="sekolah" class="form-control" placeholder="Sekolah Tujuan">
                            </div>
