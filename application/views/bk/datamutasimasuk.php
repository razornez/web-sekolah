                                ...
                                <tbody><?php $no = 1; foreach($datamutasisiswa as $res){ ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="<?php echo base_url() ?>bk/dashboard/hapusmutasimasuk/<?php echo $res->id_mutasisiswa ?>" class="btn btn-icon btn-danger btn-sm tombol-hapus"><i class="feather icon-trash-2"></i></a>
                                        </td>
                                    </tr>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Mutasi Masuk</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="<?php echo base_url() ?>bk/dashboard/simpanmutasimasuk" method="post" enctype="multipart/form-data" role="form">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <label class="floating-label" for="alasan">Sekolah Asal</label>
                                <input type="text" name="sekolah" id="sekolah" class="form-control" placeholder="Sekolah Asal">
                            </div>
