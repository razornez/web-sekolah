		...
		<div class="navbar-wrapper  ">
			<div class="navbar-content scroll-div " >
				...
				<div class="">
					...
					<div class="collapse" id="nav-user-link">
						<ul class="list-inline">
							...
							<li class="list-inline-item"><a href="<?php echo base_url() ?>sarpras/dashboard/logout" data-toggle="tooltip" title="Logout" class="text-danger"><i class="feather icon-power"></i></a></li>
						</ul>
					</div>
				</div>
				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item">
						<a href="<?php echo base_url() ?>sarpras/dashboard" class="nav-link ">
					...
					<li class="nav-item pcoded-hasmenu">
						...
						<ul class="pcoded-submenu">
							<li><a href="<?php echo base_url() ?>sarpras/dashboard/kategorisarpras">Kategori Sarpras</a></li>
                            <li><a href="<?php echo base_url() ?>sarpras/dashboard/datasarpras">Data Sarpras</a></li>
						</ul>
					</li>

          			<li class="nav-item"><a href="<?php echo base_url() ?>sarpras/dashboard/logout" class="nav-link ">
