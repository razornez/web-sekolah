<style>
    #load {
        ...
        position: fixed;
        text-indent: 100%;
        background: #e0e0e0 url('<?php echo base_url() ?>resources/images/loading.gif') no-repeat center;
		z-index: 1;
		opacity: 0.4;
		background-size: 10%;
    }
...
<body class="background-purple">
  ...
  <!-- [ Pre-loader ] End -->
	...
	<nav class="pcoded-navbar menu-black ">
		<div class="navbar-wrapper  ">
			<div class="navbar-content scroll-div " >
				...
				<ul class="nav pcoded-inner-navbar">
					...
					<li class="nav-item">
						<a href="<?php echo base_url() ?>perpustakaan/dashboard" class="nav-link ">
					...
					<li class="nav-item">
						<a href="<?php echo base_url() ?>perpustakaan/dashboard/databuku" class="nav-link ">
					...
					<li class="nav-item">
						<a href="<?php echo base_url() ?>perpustakaan/dashboard/dataanggota" class="nav-link ">
							<span class="pcoded-micon"><i class="feather icon-book"></i></span>
					...
					<li class="nav-item pcoded-hasmenu">
						...
						<ul class="pcoded-submenu">
							<li><a href="<?php echo base_url() ?>perpustakaan/dashboard/pinjambuku">Peminjaman Buku</a></li>
						</ul>
					</li>

					<li class="nav-item">
						<a href="<?php echo base_url() ?>perpustakaan/dashboard/logout" class="nav-link ">
							...
							<div class="dropdown drp-user">
								...
								<div class="dropdown-menu dropdown-menu-right profile-notification">
									<div class="pro-head">
										...
										<a href="<?php echo base_url() ?>perpustakaan/dashboard/logout" class="dud-logout" title="Logout">
