                                ...
                                <tbody><?php $no = 1; foreach($datasiswa as $res){ ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?php echo base_url() ?>master/cetak_buku/<?php echo $res->id_pendaftar ?>" target="_blank" class="btn btn-icon btn-sm" style="background-color: #900C3F; color: #ffffff;"><i class="feather icon-printer"></i></a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
