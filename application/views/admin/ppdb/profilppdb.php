                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Pengaturan PPDB</h5>
                        </div>
                        <ul class="breadcrumb">
            ...
            <div class="col-lg-8">
              <div class="card">
                  <div class="card-header card-border-c-yellow">
                    ...
                    <div class="card-body">
                    <form role="form" action="<?php echo base_url() ?>master/updatingprofilppdb_save" novalidate method="POST" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="input-group col-md-12">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">informasi PPDB</span>
                                </div>
                                <textarea class="form-control" name="informasi" aria-label="With textarea" rows="3"><?php echo $data_profilppdb->informasi ?></textarea>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div class="card card-info">
                                      <div class="card-body">
                                        <center><img style="width:150px;150px;" src="<?php echo base_url(); ?>assets/ppdb/img/<?php echo $data_profilppdb->background; ?>" class="img-responsive img-thumbnail" /></center>
                                      </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-8">
                                <div class="card card-info">
                                  <div class="card-header">
                                    <center><h6 class="card-title"><i class="fa fa-hand-o-left"></i> <strong>Ganti Background</strong> </h6></center> 
                                  </div>
                                  <div class="input-group mt-3 mb-3">
                                    <div class="custom-file ml-4 mr-4">
                                      <input type="file" name="background" class="custom-file-input form-control" id="exampleInputFile">
