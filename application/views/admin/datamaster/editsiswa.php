		...
		<div class="row">
						...
						<div class="card card-border-c-green">
							...
							<div class="card-body border-top pro-det-edit collapse show" id="pro-det-edit-1">
								<form>
                                	...
                                	<div class="form row">
										<label class="col-sm-3 font-weight-bolder">NIS / Nomor Induk</label>
										<div class="col-md-9">:
									...
									<div class="form row">
										<label class="col-sm-3 font-weight-bolder">Tingkat</label>
										<div class="col-md-9">:
                                        <?php echo $data_siswa->siswa_tingkat ?>
										</div>
									</div>
                                    <div class="form row">
										<label class="col-sm-3 font-weight-bolder">Kelas</label>
										<div class="col-md-9">:
                                        <?php echo $data_siswa->nama_kelas ?>
										</div>
									</div>
                                    <div class="form row">
							...
							<div class="card-body border-top pro-det-edit collapse " id="pro-det-edit-2">
								<form action="<?php echo base_url() ?>admin/dashboard/updatesiswa" method="POST">
									...
									<div class="form row">
										<label class="col-sm-3">Kelainan Jasmani</label>
										<div class="col-sm-9">
									...
									<div class="card alert-primary ">
										<h6>Informasi Rombongan Belajar</h6>
										<span></span>
									</div>
									 <div class="form row">
										<label class="col-sm-3">Tingkat</label>
										<div class="col-sm-9">
											<select class="form-control" id="siswa_tingkat" name="siswa_tingkat">
												<option value="<?php echo $data_siswa->siswa_tingkat ?>">Pilihan Saat ini -- <?php echo $data_siswa->siswa_tingkat ?> --</option>
                                    ...
                                    <div class="form row">
										...
										<div class="col-sm-9">
											<select class="form-control" id="siswa_kelas" name="siswa_kelas">
                                                <option value="<?php echo $data_siswa->kode_kelas ?>">Pilihan Saat ini -- <?php echo $data_siswa->nama_kelas ?> --</option>
			...
			<div class="col-md-4 order-md-1">
				<div class="card card-border-c-blue">
					...
					<div class="card-body">
                        <div class="form row">
                            <label class="col-sm-4 col-form-label font-weight-bolder">Username</label>
                            <div class="col-sm-8">
                                 <input type="text" class="form-control" value="<?php echo $data_siswa->username ?>" readonly>
                            </div>
                        </div>
                        <div class="form row">
                            <label class="col-sm-4 col-form-label font-weight-bolder">Password</label>
                            <div class="col-sm-8">
