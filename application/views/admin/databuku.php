                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table id="report-table" class="table table-bordered table-striped mb-0">
                                    ...
                                    <tbody><?php $no = 1; foreach($databuku as $res){ ?>
                                        <tr>
                                            <td class="text-center"><?php echo $no++ ?></td>
                                            <td class="text-center"><img class="card-img-top w-50" src="<?php echo base_url() ?>file/filecoverbuku/<?php echo $res->foto_buku ?>" width="25" height="120" alt="courses" /></td>
                                            <td>                
                                                <div class="d-inline-block align-middle">
                                                    <div class="d-inline-block">
                                                        <h6 class="m-b-0"><?php echo $res->nama_buku ?></h6>
                                                        <p class="m-b-0">Untuk Kelas : <?php echo $res->kelas_buku ?></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-center"><?php echo $res->kategori ?></td>    
                                            <td class="text-center"><a class="btn btn-primary" href="<?php echo base_url() ?>file/filebuku/<?php echo $res->file_buku ?>" data-toggle="modal" data-target="#modal-play<?php echo $res->id_buku ?>" role="button">Buka File</a></a></td>
                                            <td class="text-center">
                                                ...
                                                <a href="<?php echo base_url() ?>master/hapusbuku/<?php echo $res->id_buku ?>" class="btn btn-icon btn-danger btn-sm tombol-hapus"><i class="feather icon-trash-2"></i></a>
                                            </td>
                                        </tr>
                                    </tbody>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <label class="floating-label" for="nama_buku">Nama / Judul Buku</label>
                                                                    <input type="text" class="form-control" id="nama_buku" name="nama_buku" value="<?php echo $res->nama_buku ?>" autocomplete="off">
                                                            ...
                                                            <div class="col-xl-6 col-md-6 mb-5">
                                                                ...
                                                                <select class="form-control" id="kategori" name="kategori">
                                                                    <option value="<?php echo $res->kategori ?>">Kategori <span class="font-weight-bolder">(<?php echo $res->kategori ?>)</span></option>
                                                                    <option value="">---</option>
                                                            ...
                                                            <div class="col-xl-6 col-md-6 mb-5">
                                                                ...
                                                                <select class="form-control" id="kelas_buku" name="kelas_buku">
                                                                    <option value="<?php echo $res->kelas_buku ?>">Untuk Kelas <span class="font-weight-bolder">(<?php echo $res->kelas_buku ?>)</span></option>
