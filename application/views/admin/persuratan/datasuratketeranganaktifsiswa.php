                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Surat Keterangan Aktif </h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="#!">Sekolah</a></li>
                            <li class="breadcrumb-item"><a href="#!">Surat Keterangan Aktif </a></li>
                        </ul>
                    </div>
                </div>        
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Daftar Surat Keterangan Aktif</h5>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="report-table" class="table table-bordered table-striped mb-0">
                                ...
                                <tbody><?php $no = 1; foreach($datasuratketeranganaktifsiswa as $res){ ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?php echo base_url() ?>master/print_suratketeranganaktifsiswa/<?php echo $res->id_siswa ?>" class="btn btn-icon btn-info btn-sm"><i class="feather icon-printer"></i></a>
                                            <a href="<?php echo base_url() ?>master/hapussuratketeranganaktifsiswa/<?php echo $res->id_suratketeranganaktifsiswa ?>" class="btn btn-icon btn-danger btn-sm tombol-hapus"><i class="feather icon-trash-2"></i></a>
                                        </td>
                                    </tr>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Surat Keterangan Aktif</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="<?php echo base_url() ?>master/simpansuratketeranganaktif" method="post" enctype="multipart/form-data" role="form">
                    <div class="row">
