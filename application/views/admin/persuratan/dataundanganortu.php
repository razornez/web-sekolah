                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Surat Panggilan Orang Tua </h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="#!">Sekolah</a></li>
                            <li class="breadcrumb-item"><a href="#!">Surat Panggilan </a></li>
                        </ul>
                    </div>
                </div>        
            </div>
                                ...
                                <tbody><?php $no = 1; foreach($dataundanganortu as $res){ ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?php echo base_url() ?>master/print_undanganortu/<?php echo $res->id_siswa ?>" class="btn btn-icon btn-info btn-sm"><i class="feather icon-printer"></i></a>
                                            <a href="<?php echo base_url() ?>master/hapusundanganortu/<?php echo $res->id_undanganortu ?>" class="btn btn-icon btn-danger btn-sm tombol-hapus"><i class="feather icon-trash-2"></i></a>
                                        </td>
                                    </tr>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url() ?>master/simpanundanganortu" method="post" enctype="multipart/form-data" role="form">
                    <div class="row">
