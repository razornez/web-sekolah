                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group mb-0"><?php foreach($nilai_smt2 as $res){ ?>  <?php } ?>
                            <a href="<?php echo base_url() ?>master/hapussemuanilaismt2/<?php echo $res->kode_mapel ?>" class="btn btn-danger btn-sm btn-round has-ripple" ><i class="fa fa-download"></i>Kosongkan Nilai</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <table id="report-table" class="table table-bordered table-striped mb-0">
                            ...
                            <tbody><?php $no = 1; foreach($nilai_smt2 as $res){ ?>
                                <tr>
                                    ...
                                    <a href="<?php echo base_url() ?>master/hapusnilaismt2/<?php echo $res->id_rapor ?>" class="btn btn-icon btn-danger btn-sm tombol-hapus"><i class="feather icon-trash-2"></i></a>
                                    </td>
                                </tr>
                                        ...
                                        <div class="modal-dialog modal-md">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="<?php echo base_url() ?>master/updaterapor2" method="POST">
                                                        <div class="row">
