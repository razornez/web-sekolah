                        ...
                        <table id="report-table" class="table table-bordered table-striped mb-0">
                            ...
                            <tbody><?php $no = 1; foreach($nilai_smt4 as $res){ ?>
                                <tr>
                                    ...
                                    <a href="<?php echo base_url() ?>master/hapusnilaismt4/<?php echo $res->id_rapor ?>" class="btn btn-icon btn-danger btn-sm tombol-hapus"><i class="feather icon-trash-2"></i></a>
                                    </td>
                                </tr>
                                        ...
                                        <div class="modal-dialog modal-md">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="<?php echo base_url() ?>master/updaterapor4" method="POST">
                                                        <div class="row">
