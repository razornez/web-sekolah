                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Data Nilai Rapor Smt 3</h5>
                        </div>
                        <ul class="breadcrumb">
                                ...
                                <tbody><?php $no = 1; foreach($datarapormapelnilai as $res){ ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?php echo base_url() ?>master/nilaismt3/<?php echo $res->kode_mapel ?>" class="btn btn-icon btn-info btn-sm"><i class="feather icon-search"></i></a>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="<?php echo base_url() ?>import/uploadnilaismt3" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-12">
