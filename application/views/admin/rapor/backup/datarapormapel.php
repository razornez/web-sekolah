                ...
                <form action="<?php echo base_url() ?>master/simpandatarapormapel" method="post" enctype="multipart/form-data" role="form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group">
                                <label class="floating-label" for="nama_mapel">Nama Mata Pelajaran</label>
                                <input type="text" class="form-control" id="nama_mapel" name="nama_mapel" placeholder="Matematika">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="kkm" name="kkm" placeholder="80">
                            </div>
                        </div>
