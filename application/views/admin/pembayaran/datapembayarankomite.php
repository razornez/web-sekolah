                    ...
                    <div class="card-header">
                            <div class="col-sm-12 text-right">
                              <!-- <button class="btn btn-success btn-sm btn-round has-ripple" data-toggle="modal" data-target="#modal-report"><i class="feather icon-plus"></i> Tambah Siswa</button>end -->  
                                <button class="btn btn-info btn-sm btn-round has-ripple" data-toggle="modal" data-target="#modal-import"><i class="feather icon-upload"></i> Import Siswa</button>
                                ...
                                <a href="<?php echo base_url() ?>master/download_templatesiswa" class="btn btn-secondary btn-sm btn-round has-ripple" ><i class="fa fa-download"></i> Download Template</a>
                                <a href="<?php echo base_url() ?>master/hapussemuasiswa" class="btn btn-danger btn-sm btn-round has-ripple" ><i class="fa fa-download"></i>Kosongkan Siswa</a>
                            </div>
