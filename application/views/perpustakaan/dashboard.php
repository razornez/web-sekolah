    ...
    <div class="pcoded-content">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                ...
                <div class="row">
                        <div class="col-sm-12">
                            <div class="card social-card bg-c-info">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col  text-black">
                                            <h6 class="m-b-0 text-center text-black"><img style="width:75px;75px;" src="<?php echo base_url(); ?>upload/<?php echo $data_lembaga->logo; ?>" class="img-responsive" /> <br>E-PERPUSTAKAAN <br> <?php echo $data_lembaga->nama_lembaga ?></h6>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card social-card bg-c-blue">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <h6 class="m-b-0 text-white">KOLEKSI BUKU</h6>
                                            <p><?php echo $this->db->count_all_results('sarpras'); ?> Data</p>
                                            <p class="m-b-0">Data yang masuk dalam database smartschool</p>
                                        </div>
                                    </div>
                                </div>
                                <a href="#" class="download-icon"><i class="feather icon-arrow-down"></i></a>
                        ...
                        <div class="card social-card bg-c-blue">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <h6 class="m-b-0 text-white">ANGGOTA</h6>
                                            <p><?php echo $this->db->count_all_results('pendaftar'); ?> Data</p>
                                            <p class="m-b-0">Data yang masuk dalam database smartschool</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card social-card bg-c-blue">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <h6 class="m-b-0 text-white">TRANSAKSI</h6>
                                            <p><?php echo $this->db->count_all_results('pinjamanbuku'); ?> Data</p>
                                            <p class="m-b-0">Data yang masuk dalam database smartschool</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card social-card bg-c-blue">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <h6 class="m-b-0 text-white">Data PERPUSTAKAAN</h6>
                                            <p><?php echo $this->db->count_all_results('sarpras'); ?> Data</p>
                                            <p class="m-b-0">Data yang masuk dalam database smartschool</p>
                                        </div>
                                    </div>
