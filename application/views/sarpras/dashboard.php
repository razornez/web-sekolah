                ...
                <div class="row">
                        <div class="col-sm-6">
                            <div class="card social-card bg-c-red">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col-auto">
                                            <i class="feather icon-box f-34 text-c-red social-icon"></i>
                                        </div>
                                        <div class="col">
                                            <h6 class="m-b-0 text-white">Kategori Sarpras</h6>
                                            <p><?php echo $this->db->count_all_results('kategorisarpras'); ?> Kategori</p>
                        ...
                        <div class="card social-card bg-c-blue">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col-auto">
                                            <i class="feather icon-server f-34 text-c-blue social-icon"></i>
                                        </div>
                                        <div class="col">
                                            <h6 class="m-b-0 text-white">Data Sarpras</h6>
