...
class Loginbk extends CI_Controller {
    ...
    public function index()
    {
        $data = array(
            ...
            if($this->bk->is_logged_in())
            {
                ...
                $checking = $this->bk->check_login('tbl_users', array('username' => $username), array('password' => $password));
