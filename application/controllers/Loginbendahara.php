...
class Loginbendahara extends CI_Controller {
    ...
    public function index()
    {
        $data = array(
            ...
            if($this->bendahara->is_logged_in())
            {
                ...
                $checking = $this->bendahara->check_login('tbl_users', array('username' => $username), array('password' => $password));
                ...
                if ($checking != FALSE) {
                    foreach ($checking as $apps) {
                        ...
                        }elseif  ( $this->session->userdata("role") == "sarpras"){ redirect('sarpras/dashboard/');
                    ...
                    $this->load->view('login/loginbendahara', $data);
                }
